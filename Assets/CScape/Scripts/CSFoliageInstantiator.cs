...
namespace CScape
{
  ...
  //          parentSection = gameObject.transform.parent.gameObject.GetComponent<StreetModifier>();
        ...
        {
#if UNITY_EDITOR
            isPrefabOriginal = UnityEditor.PrefabUtility.GetCorrespondingObjectFromSource(gameObject) == null && UnityEditor.PrefabUtility.GetPrefabObject(gameObject.transform) != null;
#endif
            if (!isPrefabOriginal)
            {
