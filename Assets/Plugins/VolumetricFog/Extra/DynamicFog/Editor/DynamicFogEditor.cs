...
namespace DynamicFogAndMist {
				...
				public class DynamicFogEditor : Editor {
								...
								static int[] FOG_TYPE_VALUES = new int[] { 0, 3, 1, 2, 4, 5 };
								...
								SerializedProperty effectType, preset, useFogVolumes, enableDithering, useSinglePassStereoRenderingMatrix;
								...
								void OnEnable () {
												...
												useSinglePassStereoRenderingMatrix = serializedObject.FindProperty ("useSinglePassStereoRenderingMatrix");
