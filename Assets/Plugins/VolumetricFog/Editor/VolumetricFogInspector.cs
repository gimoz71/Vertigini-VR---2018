				...
				public class VolumetricFogInspector : Editor {
								...
								public override void OnInspectorGUI () {
												...
												if (expandOptimizationSettingsSection) {
																...
																GUI.enabled = false;
																EditorGUILayout.BeginHorizontal ();
																GUILayout.Label (new GUIContent ("Single Pass Stereo", "Enables Single Pass Stereo Rendering when using in VR (automatically set based on player settings)."), GUILayout.Width (120));

																#if UNITY_5_5_OR_NEWER
																_fog.useSinglePassStereoRenderingMatrix = PlayerSettings.stereoRenderingPath == StereoRenderingPath.SinglePass;
																		#else
																	_fog.useSinglePassStereoRenderingMatrix = PlayerSettings.singlePassStereoRendering;
																			#endif

																_fog.useSinglePassStereoRenderingMatrix = EditorGUILayout.Toggle (_fog.useSinglePassStereoRenderingMatrix, GUILayout.Width (20));
																EditorGUILayout.EndHorizontal ();
																GUI.enabled = true;
																#endif
												}
